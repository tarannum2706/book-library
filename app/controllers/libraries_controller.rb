class LibrariesController < ApplicationController
  ...
  # GET /libraries/new
  def new
     # @library = current_user.librarian.libraries.new
    @library = Library.new
  end
  ...
  def create
    @library = Library.new(library_params)
     # @library = current_user.librarian.libraries.new(library_params)
  ...
  private
    ...
    def library_params
      params.require(:library).permit(:name, :email_id, :library , :user_id)
    end
end
